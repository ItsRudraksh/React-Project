...
const News = () => {
  // Data for news items including text, heading, description, image source, and CSS classes
  const agencyData = [
    {
      topText: "Jan 4, 2016   |   In Culture",
      heading: "Akita Inu Dog",
  ...
  return (
    // Main container for the News section with flexible height and full width
    <div id="news" className="flex flex-col h-max w-full">
      {agencyData.map((agency, index) => (
        // Container for each news item with dynamic classes and responsive design
        <div
          key={index}
          className={`${agency.classes} justify-between items-center flex-wrap sm:gap-10 sm:justify-center sm:py-10 sm:text-center md:gap-10 md:justify-center md:py-10 md:text-center`}
        >
