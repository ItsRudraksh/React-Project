  ...
  return (
    <div id="contact">
      <div className="relative flex flex-col items-center justify-center">
        <div>
          <img src="/Images/form-bg.png" alt="" className="relative" />
        </div>
        <div className="absolute flex flex-col items-center justify-start">
          ...
          <form
            ...
            className="flex flex-col gap-4 items-center justify-center w-max"
          >
            <div className="flex gap-6">
              <input
                type="text"
                className="w-80 h-12 pl-4 bg-[rgba(0,0,0,0.1)] border-2 border-white outline-none text-white focus:outline-none"
                placeholder="Name"
      ...
      <div className="text-white flex justify-between items-center px-60 py-4">
